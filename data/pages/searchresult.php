...
<?php include '../common/sidebar.php'; ?>
   ...
   <section class="content">
          <div class="row">
		  <?php $var_value=$_POST['txt']; ?>
           <?php 

            $i=1;
            $q=$d->select("appdetails","app_name LIKE '%$var_value%'");
		  ...
		  <div class="col-sm-3">
            ...
            echo '<a  target="_blank"  href=https://play.google.com/store/apps/details?id='.$row['pkg_name'].'>'.'<img  height="20" style="float: left" width="20" src="https://www.gstatic.com/android/market_images/web/favicon_v2.ico"/></a>';
                  ...
                  <div class="text-muted" style="white-space: nowrap;overflow: hidden;text-overflow:ellipsis;"> DEV:-> <a  href=#?developer_ac=<?php echo $row['developer_ac']; ?>><?php echo $row['developer_ac']; ?></a> <br/>  <?PHP echo $row['downloads']; ?> Downloads          
          <br/>  
